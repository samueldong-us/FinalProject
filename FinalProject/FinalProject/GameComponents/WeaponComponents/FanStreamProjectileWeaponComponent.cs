...
{
    internal class FanStreamProjectileWeaponComponent : ProjectileWeaponComponent
    {
        ...
        public FanStreamProjectileWeaponComponent(Entity entity, int numberOfBullets, int damage)
        ...
        protected override void Fire()
        {
            ...
            for (int j = 0; j < 10; j++)
            {
                for (int i = -numberOfBullets / 2; i <= numberOfBullets / 2; i++)
                {
                    ...
                    new DelayedSetVelocityComponent(bullet, 1, MathUtilities.VectorFromMagnitudeAndAngle(Speed * (15 - j), modifiedBulletAngle));
