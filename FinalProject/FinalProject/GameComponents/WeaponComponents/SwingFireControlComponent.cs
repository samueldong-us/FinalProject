...
{
    internal class SwingFireControlComponent : Component
    {
        private bool active;
        private float delay;
        private bool firing;
        ...
        public SwingFireControlComponent(Entity entity, float timeBetweenShots, float lengthOfFire, float delay)
            : base(entity)
        {
