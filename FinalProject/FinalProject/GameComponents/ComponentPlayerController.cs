...
{
    internal class ComponentPlayerController : Component
    {
        private Dictionary<Keys, bool> isDown;

        private float speed;

        public ComponentPlayerController(Entity entity, float speed)
            : base(entity)
        {
            ...
            this.speed = speed;
            ScreenGame.MessageCenter.AddListener<Keys>("Key Pressed", KeyPressed);
            ScreenGame.MessageCenter.AddListener<Keys>("Key Released", KeyReleased);
        }
