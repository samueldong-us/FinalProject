...
{
    internal class ColliderComponent : DrawableComponent
    {
        ...
        public ColliderComponent(Entity entity, Rectangle source, List<Triangle> triangles, string colliderLayer)
            : base(entity, "Debug")
        {
            this.source = source;
            ...
            GameScreen.Collisions.AddCollider(colliderLayer, this);
        ...
        {
            GameScreen.Collisions.RemoveCollider(colliderLayer, this);
            base.Dispose();
        }
