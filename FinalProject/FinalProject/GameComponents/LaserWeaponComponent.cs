...
namespace FinalProject.GameComponents
{
    internal class LaserWeaponComponent : Component
    {
        ...
        private void StartFiring()
        {
            ...
            new ColliderComponent(laser, GameAssets.Unit["Laser Beam"], GameAssets.UnitTriangles["Laser Beam"], GameScreen.CollidersPlayerBullets).DebugDraw();
            new TextureRendererComponent(laser, GameAssets.UnitTexture, GameAssets.Unit["Laser Beam"], Color.White, GameScreen.LayerPlayerBullets);
