...
namespace FinalProject.Screens
{
    internal class ItemUpgrade : ItemMenu
    {
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            GraphicsUtilities.DrawStringVerticallyCentered(spriteBatch, Fonts.UpgradeNameFont, Fonts.Red, position + new Vector2(1000, 27), "COST: " + (level == 10 ? "MAX" : GetCost() + ""));
        }

        public int GetCost()
        {
            return level == 10 ? 0 : 100 * level * level;
        }
    }
}